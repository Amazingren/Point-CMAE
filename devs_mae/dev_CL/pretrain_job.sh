...
#SBATCH --output=./joblogs/dev_CL.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/dev_CL.error     # Redirect stderr to a separate error log file
