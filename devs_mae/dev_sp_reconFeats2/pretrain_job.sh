#!/bin/bash
#SBATCH --job-name=dev_sp_reconFeats2
...
#SBATCH --output=./joblogs/dev_sp_reconFeats2.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/dev_sp_reconFeats2.error     # Redirect stderr to a separate error log file
