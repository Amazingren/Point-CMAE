...
#SBATCH --output=./joblogs/sponly.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/sponly.error     # Redirect stderr to a separate error log file
