#!/bin/bash
#SBATCH --job-name=ab_mae_byol_275_cls
...
#SBATCH --output=./joblogs/ab_mae_byol_275_cls.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/ab_mae_byol_275_cls.error     # Redirect stderr to a separate error log file
