...
#SBATCH --output=./joblogs/dev_sp_again.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/dev_sp_again.error     # Redirect stderr to a separate error log file
