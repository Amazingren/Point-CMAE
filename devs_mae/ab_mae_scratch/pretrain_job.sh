...
#SBATCH --output=./joblogs/mae_base.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/mae_base.error     # Redirect stderr to a separate error log file
