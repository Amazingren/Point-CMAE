#!/bin/bash
#SBATCH --job-name=ab_DM_cos_6_aug_ep250_cls
...
#SBATCH --output=./joblogs/ab_DM_cos_6_aug_ep250_cls.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/ab_DM_cos_6_aug_ep250_cls.error     # Redirect stderr to a separate error log file
