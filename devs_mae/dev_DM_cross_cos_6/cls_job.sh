#!/bin/bash
#SBATCH --job-name=ab_linear_hardest_ep275
...
#SBATCH --output=./joblogs/ab_linear_hardest_ep275.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/ab_linear_hardest_ep275.error     # Redirect stderr to a separate error log file
...
python main.py \
    ...
    --finetune_model \
    --exp_name ab_linear_hardest_ep275 \
