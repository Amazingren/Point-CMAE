...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    spike_idx = 0
    model_components = set([n[7:].split('.')[0] for n,p in base_model.named_parameters() if p.requires_grad])
    ...
    return metrics, metrics_vote, best_metrics, best_metrics_vote
