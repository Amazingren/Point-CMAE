#!/bin/bash
#SBATCH --job-name=finetune_scanobj_objbg
#SBATCH --nodelist=gcp-eu-2
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=a100-40g:1
#SBATCH --output=./joblogs/cmae_cls_scanobj_objbg.log   
#SBATCH --error=./joblogs/cmae_cls_scanobj_objbg.error
...
python ../main.py \
    ...
    --finetune_model \
    --exp_name cmae_cls_scanobj_objbg \
