...
#SBATCH --output=./joblogs/v1-5.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/v1-5.error     # Redirect stderr to a separate error log file
...
python main.py \
    ...
    --exp_name v1-5_noMAE_ReBlock_sp_mask0_newloss
