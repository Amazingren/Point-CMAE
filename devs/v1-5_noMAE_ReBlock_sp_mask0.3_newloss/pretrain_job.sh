...
#SBATCH --output=./joblogs/v1-5_mask0.3.log      # Redirect stdout to a log file
#SBATCH --error=./joblogs/v1-5_mask0.3.error     # Redirect stderr to a separate error log file
...
python main.py \
    ...
    --exp_name v1-5_noMAE_ReBlock_sp_mask0.3_newloss
